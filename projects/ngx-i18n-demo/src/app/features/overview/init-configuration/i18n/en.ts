...
const en: typeof zh_TW = {
  ...
  "enablePageFallback-des": "Supports the reuse of translation resources from ancestor components.\nThis allows translation resources defined within page-level components to be utilized by other nested components, such such as those for selection fields (select), tables, and similar components.\nThis feature must be enabled by setting the second parameter in the page component's translationProvider() call to true.",
  "fallbackNamespace-des": "Global namespace / fallback namespace.\nUsed when the current namespace is missing a key.",
  "fallbackNamespace-ex": "ex. 'common' allows every component to reuse this namespace.",
