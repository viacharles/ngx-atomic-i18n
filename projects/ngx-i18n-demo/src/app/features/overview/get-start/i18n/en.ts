...
const en: typeof zh_TW = {
  ...
  '需求': 'Requirements',
  'Angular 16+ (無 peerDependencies)': 'Angular 16+ (no peerDependencies)',
  '說明': 'Details',
  '優點': 'Benefits',
  ...
  '可設定沿用父元件的翻譯資源': 'Option to inherit translation assets from parent component',
  '體積最小化': 'Minimized bundle size',
  '效能最佳化': 'Optimized performance',
  '不閃 key': 'No key flicker',
  '開始使用': 'Get started',
  '安裝': 'Install',
